...
const onCollectStar = (this_: any) => {
    let scoreText: any
    scoreText = this_.add.text(16, 16, `Score: ${state.score}`, { fontSize: '32px', fill: '#000' } as any);
...
export const createStars = (this_: any, player:Phaser.Types.Physics.Arcade.SpriteWithDynamicBody, platforms: any) => {
